...
const FEATURES = [
  ...
  'Panneaux amovibles 120 × 150 cm',
  'Lame de bois traité autoclave Classe 4',
  'Lestage adaptable selon zone géographique et terrain',
  'Livraison + reprise incluses dans la location',
];

export function TotemCaissonBoisLocationPage() {
  ...
  const handleAddToCart = () => {
    ...
    addItems([{
      id: 'totem-caisson-bois-120-location',
      type: 'totem' as const,
      name: `Totem Caisson Bois 120 (Location — ${dureeLabel})`,
      price: 0,
      quantity,
      details: { itemType: 'totem', format: '120', mode: 'location', duree: dureeLabel },
    }]);
    openSidebar();
  };
  ...
  return (
    <>
      <SEOMeta
        title="Totem Caisson Bois 120 — Location"
        description="Louez le Totem Caisson Bois 120 cm pour vos événements et chantiers. À partir de 320 € HT. Livraison + reprise incluses."
        keywords="location totem Caisson Bois, totem bois chantier, location totem 120, Urbyn location"
        url="/totem/caisson-bois-120/location"
        type="product"
        ...
        <div className="grid md:grid-cols-2 gap-8">
          ...
          <div>
            <div className="rounded-xl overflow-hidden bg-gray-100 aspect-square mb-4">
              <ImageWithFallback
                src={imgCaissonBois120}
                alt="Totem Caisson Bois 120 Location"
            ...
            <div className="border border-slate-200 rounded-lg divide-y divide-slate-100">
              {[
                { label: 'Dimensions', value: 'L 128,8 cm × H 210,5 cm × P 90 cm' },
                { label: 'Poids', value: '325 kg' },
                { label: 'Encombrement au sol', value: '1,16 m²' },
                { label: 'Format panneau', value: '120 × 150 cm' },
              ].map(({ label, value }) => (
          ...
          <div className="space-y-6">
            <div>
              <h1 className="text-3xl font-bold text-black mb-1">Totem Caisson Bois 120</h1>
              <p className="text-gray-500 text-sm">Location — format 120 cm</p>
              <p className="text-lg font-semibold text-black mt-2">À partir de 320€ HT</p>
